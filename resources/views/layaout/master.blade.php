...
<body class="g-sidenav-show  bg-gray-200">
    <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
        <div class="sidenav-header">
            ...
            <a class="navbar-brand m-0" target="_blank">
                ...
                <span class="ms-1 font-weight-bold text-white">ARARAT</span>
            </a>
        </div>
        ...
        <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <<<<<<< HEAD <a class="nav-link text-white " href="#">
                        =======
                        <a class="nav-link text-white " href="productos">
                            >>>>>>> 4641156543ef2de326fd07d4a1e4d9b84a2d2b71
                            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                ...
                <li class="nav-item">
                    <<<<<<< HEAD <a class="nav-link text-white " href="#">
                        =======
                        <a class="nav-link text-white " href="tipoProducto">
                            >>>>>>> 4641156543ef2de326fd07d4a1e4d9b84a2d2b71
                            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                                <i class="material-icons opacity-10">view_in_ar</i>
                            </div>
                            <span class="nav-link-text ms-1">Tipo de Productos</span>
                        </a>
                </li>
                <li class="nav-item">
                    <<<<<<< HEAD <a class="nav-link text-white " href="#">
    ...
    <div class="fixed-plugin">
        ...
        <div class="card shadow-lg">
            ...
            <div class="card-body pt-sm-3 pt-0">
                <!-- Sidebar Backgrounds -->
                <div>
                    <h6 class="mb-0">Barra de menu</h6>
                </div>
    ...
    <script src="assets/js/plugins/maind2.min.js"></script>
    <!-- Github buttons -->
